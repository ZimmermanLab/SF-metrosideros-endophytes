...
tbas_with_site %>%
  ...
  kable(col.names = c("Class", "Order", "Number of sequences"),
        caption =
          "Abundances of classes of Ascomycota across all trees and sites.",
        booktabs = TRUE,
...
```{r taxonomy-by-site-plot, fig.width=6, fig.height=8, fig.cap="Normalized relative abundances of Ascomycota taxa in each site."}
