...
```{r permanova-table}
adonis(otu_table_trees ~ trees$Site_ID + trees$DBH_cm,
       strata = trees$Site_ID)$aov.tab %>%
  broom::tidy() %>%
  kable(col.names = c("Term", "df", "Sum of Squares", "Mean of Squares", "F", "R^2", "p-value"),
        caption =
