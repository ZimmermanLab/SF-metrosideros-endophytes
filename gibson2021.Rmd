...
>>>>>>> 0a77857fe361d296590fd405d9ab21582c52454e
...
iso_freq_plot <- trees %>%
  ...
  scale_x_discrete(labels = c("Ocean",
                              "Balboa",
                              "Mt. Davidson",
                              "Freeway",
                              "Downtown",
                              "Bay")) +
  ggtitle("Isolation Frequencies") +
  xlab("Site") +
...
dbh_plot <- trees %>%
  ...
  scale_x_discrete(labels = c("Ocean",
                              ...
                              "Downtown",
                              "Bay")) +
  ggtitle("Diameter at Breast Height") +
  xlab("Site") +
...
stacked_bar_order <- tbas_with_site %>%
  ...
  scale_x_discrete(limits =  c("S6",
                   ...
                   labels = c("Ocean",
                              ...
                              "Downtown",
                              "Bay")) +
  ggtitle("Relative abundances of fungal orders by site") +
  ylab("Relative abundance") +
  xlab("Site") +
  theme_few() +
